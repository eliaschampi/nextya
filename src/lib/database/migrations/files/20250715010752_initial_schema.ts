...
export async function up(db: Kysely<unknown>): Promise<void> {
	...
	// Generated from: 00-config.sql, 01-tables.sql, 02-constraints-indexes.sql, 03-functions-dashboard.sql, 03-functions-dashboard2.sql, 03-functions.sql, 04-views.sql, 05-grants.sql

	await sql`-- Config (00-config.sql)
-- =====================================================
...
-- Constraints Indexes (02-constraints-indexes.sql)
-- =====================================================
...
-- Functions Dashboard (03-functions-dashboard.sql)
-- =====================================================
...
-- Functions Dashboard2 (03-functions-dashboard2.sql)
-- =====================================================
...
GRANT SELECT ON public.student_register_results TO postgres;`.execute(db);
}
